...
/*
    ...
    1) E save(E entity);
        ...
        - 매개변수의 데이터값 중 Id 값이 DB에 존재하는 경우 update / 존재하지 않을 경우 insert
    ...
    - 별도 쿼리 작성 없이 이름 규칙에 따라 Spring Date JPA 가 내부에서 해석하여 쿼리를 생성
    ...
    1) 쿼리 메서드 기본 구조
    - 보통 find, read, ge, query 같은 키워드로 시작 (주로 find 사용)
    ...
    GreaterThen / GreaterThenEqual : 초과, 이상
