...
/*
    ...
    : 앤터프라이즈 애플리케이션 개발을 위한 자바 개발의 강력한 프레임 워크
    ...
    4. DispatcherServlet(디스패처 서블릿, dispatch)
    : 스프링부트의 핵심 서블릿
    ...
    2) Handler(Controller) 조회
        ...
        Ex) /student => StudentController 가 매핑
    ...
    2. 스프링부트(MVC)
        ...
        2) 서블릿 레벨이 DispatcherServlet 1개면 충분 (스프링이 자동 등록)
          - 컨트롤러 클래스/매서드는 여러 개
            ...
            cf) POJO 메서드
                : 특정 클래스 내부의 정의된 메서드를 의미
                - 특정 프레임워크나 기술에 종속되지 않고 순수하게 데이터와 로직을 캡슐화 하는 객체를 의미
 */
