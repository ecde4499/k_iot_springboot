...
public interface G_AdminService {
    ...
    ResponseDto<RoleManageResponse.AddRoleResponse> addRoles(UserPrincipal principal, RoleManageRequest.@Valid AddRoleRequest req);

    ResponseDto<RoleManageResponse.RemoveRoleResponse> removeRoles(UserPrincipal principal, RoleManageRequest.@Valid RemoveRoleRequest req);
}
